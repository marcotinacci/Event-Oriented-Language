 ...
 * <ul>
 *   <li>{@link org.mt.lic.eol.eventOrientedLanguage.impl.VariableReferenceImpl#getVar <em>Var</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableReferenceImpl extends MathExpressionImpl implements VariableReference
{
  ...
  {
    return EventOrientedLanguagePackage.Literals.VARIABLE_REFERENCE;
  }
    ...
    if (var != null && var.eIsProxy())
    {
      ...
      if (var != oldVar)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EventOrientedLanguagePackage.VARIABLE_REFERENCE__VAR, oldVar, var));
      }
    }
    return var;
  }
  ...
  public void setVar(VariableDeclaration newVar)
  {
    ...
    var = newVar;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EventOrientedLanguagePackage.VARIABLE_REFERENCE__VAR, oldVar, var));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EventOrientedLanguagePackage.VARIABLE_REFERENCE__VAR:
